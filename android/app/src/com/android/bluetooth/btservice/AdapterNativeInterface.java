...
public class AdapterNativeInterface {
    ...
    boolean interopMatch(String featureName, String address) {
        return interopMatchNative(featureName, address);
    }
    ...
    private native boolean interopMatchNative(String featureName, String address);
