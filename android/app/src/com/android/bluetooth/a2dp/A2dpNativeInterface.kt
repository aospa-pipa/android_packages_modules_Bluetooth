...
class A2dpNativeInterface(
    ...
    companion object {
        private val TAG = A2dpNativeInterface::class.java.simpleName
    }
    /**
    ...
    fun setStreamMode(isGamingEnabled: Boolean, isLowLatencyEnabled: Boolean) {
    ...
    private external fun setStreamModeNative(isGamingEnabled: Boolean, isLowLatencyEnabled: Boolean)
