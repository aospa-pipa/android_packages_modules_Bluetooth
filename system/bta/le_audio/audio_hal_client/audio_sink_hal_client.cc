...
public:
  ...
  ::bluetooth::le_audio::types::VendorDataPathConfiguration GetVendorConfigureDataPathPayload(
          ...
          ::bluetooth::le_audio::types::LeAudioContextType context_type, bool is_cis_dir_sink,
          bool is_cis_dir_source) override;
...
SinkImpl::GetVendorConfigureDataPathPayload(
    std::vector<uint16_t> /* conn_handles */,
    ::bluetooth::le_audio::types::LeAudioContextType /* context_type */,
    bool /* is_cis_dir_sink */, bool /* is_cis_dir_source */) {
  log::error("GetVendorConfigureDataPathPayload() is not supported for sink direction.");
  return {};
}
