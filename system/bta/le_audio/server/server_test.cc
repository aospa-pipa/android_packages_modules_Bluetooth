...
public:
  ...
  MOCK_METHOD(void, SetData, (int, bool, std::vector<uint8_t>, std::vector<uint8_t>, StatusCallback));
  ...
  MOCK_METHOD(void, StartAdvertisingSet,
              (uint8_t, int, IdTxPowerStatusCallback, AdvertiseParameters, std::vector<uint8_t>,
               ...
               PeriodicAdvertisingParameters, std::vector<uint8_t>, std::vector<uint8_t>,
               uint16_t, uint8_t, std::vector<uint8_t>, IdStatusCallback));
  ...
  MOCK_METHOD(void, SetPeriodicAdvertisingData,
              (int, std::vector<uint8_t>, std::vector<uint8_t>, StatusCallback));
  MOCK_METHOD(void, CreateBIG, (int, CreateBIGParameters, CreateBIGCallback));
  MOCK_METHOD(void, TerminateBIG, (int, int, int, TerminateBIGCallback));
