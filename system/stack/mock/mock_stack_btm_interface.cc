...
struct btm_client_interface_t btm_client_interface = {
        ...
        .sco = {
                ...
                .BTM_ReadScoBdAddrByHandle =
                        [](uint16_t /* hci_handle */) -> const RawAddress* {
                          return nullptr;
                        },
        },
        .local = {
        ...
        .vendor =
                {
                        ...
                        .BTM_GetQllLocalSupportedFeatures = 
                                [](uint8_t* len) {
                                        return btm_client_interface_mock->BTM_GetQllLocalSupportedFeatures(len);
                                },
                },
};
}  // namespace
