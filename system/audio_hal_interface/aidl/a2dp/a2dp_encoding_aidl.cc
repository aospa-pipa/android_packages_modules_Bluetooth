...
provider::get_a2dp_configuration(
  ...
  if (aidl_codec_id.has_value() && aidl_codec_id->getTag() == CodecId::vendor) {
    int vendor_id = aidl_codec_id->get<CodecId::vendor>().id;
    int codec_id = aidl_codec_id->get<CodecId::vendor>().codecId;
